...
- [ ] **CSV-02**: Each scan appends new rows to the CSV in GH-flavored markdown table format with columns: Date Added, Company, Role, Location, URL, Source, Age, Application
...
- [ ] **CSV-09**: E2E test covers CSV append behavior (rows added correctly, format stable, no duplicates within CSV)
