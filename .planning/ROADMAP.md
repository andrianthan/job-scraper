...
- [ ] **Phase 1: Scanner Hardening** - Make the existing scanner robust: error isolation, retries, run summary, parked boards, Workday banks
...
|-------|----------------|--------|-----------|
| 1. Scanner Hardening | 0/TBD | Not started | - |
